        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionName = table.Column<string>(type: "varchar(30)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersUIDs", x => x.Code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserUIDCode = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_UsersUIDs_UserUIDCode",
                        column: x => x.UserUIDCode,
                        principalTable: "UsersUIDs",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_INSERT = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    date_UPDATE = table.Column<DateTime>(type: "datetime", nullable: true),
                    user_REVIEW = table.Column<string>(type: "varchar(50)", nullable: true),
                    date_REVIEW = table.Column<DateTime>(type: "dateTime", nullable: true),
                    IST_duration = table.Column<int>(type: "int", nullable: true),
                    CAPIExported = table.Column<short>(type: "smallint", nullable: true),
                    ComputerName = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    RENAME = table.Column<int>(type: "int", nullable: true),
                    TIP1 = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserUIDCode",
                table: "AspNetUsers",
                column: "UserUIDCode");
